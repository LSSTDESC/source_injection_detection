...
#============================
def get_single_stamp(system_index, time_index):
    ...
    plt.colorbar()
    plt.tight_layout()
    plt.savefig("%s/%s.png"%(FIG_FOLDER, image_tag) )
    
    #----------------------------------
    fits.writeto("%s/%s.fits"%(FIG_FOLDER, image_tag), system_image, overwrite=True)
...
#============================
def get_coadd_stamp(system_index):
    ...
    #----------------------------------
    fits.writeto("%s/%s.fits"%(FIG_FOLDER, image_tag), mean_image, overwrite=True)
    
    return mean_image


#============================
def get_diff_stamp(system_index, time_index):
    ...
    single_image_path = "%s/%s.fits"%(FIG_FOLDER, single_image_tag)
    ...
    coadd_image_path = "%s/%s.fits"%(FIG_FOLDER, coadd_image_tag)
